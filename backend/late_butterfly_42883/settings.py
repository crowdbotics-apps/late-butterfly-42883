"""
Django settings for late_butterfly_42883 project.
...
ROOT_URLCONF = 'late_butterfly_42883.urls'
...
WSGI_APPLICATION = 'late_butterfly_42883.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_butterfly_42883 API",
    "DESCRIPTION": "API documentation for late_butterfly_42883 App",
    "VERSION": "v1",
}
